...
- `gui/appearance.py`는 `font/02_NotoSansCJK-TTF-VF/Variable/TTF/Subset/NotoSansKR-VF.ttf`의 wght=400과 창/트레이 아이콘을 설정한다. 해당 한국어 폰트와 배포 LICENSE만 남기고 사용자가 제공한 묶음의 불필요한 폰트 16개를 삭제했다.
